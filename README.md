...
При использовании JS я стараюсь придерживаться последнего стандарты ECMAScript, а стили делаю с использованием SASS.
...
Это любые JS-файлы в указанной папке. На выходе получите 2 файла: собранный оригинал и его ES5-версия. Так что можно смело использовать все прелести последнего стандарта ECMAScript (ES6 и позже), не парясь о работе кода в каком-нибудь IE10.
